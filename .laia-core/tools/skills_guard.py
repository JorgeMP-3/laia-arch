...
Trust levels:
  - builtin:   Ships with LAIA. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.laia/\.env|\~/\.laia/\.env',
     "laia_env_access", "critical", "exfiltration",
     "directly references LAIA secrets file"),
    ...
    (r'\.laia/config\.yaml|\.laia/SOUL\.md',
     "laia_config_mod", "critical", "persistence",
     "references LAIA configuration files directly"),
