...
def _enable_managed_nous_tools(monkeypatch):
    ...
    laia_cli.auth and laia_cli.models — so the function body returns True.
    """
    monkeypatch.setattr("laia_cli.auth.get_nous_auth_status", lambda: {"logged_in": True})
    monkeypatch.setattr("laia_cli.models.check_nous_free_tier", lambda: False)
