"""Tests for the interactive session browser (`laia sessions browse`).
...
from laia_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """laia sessions browse should be parseable."""
        from laia_cli.main import main as _main_entry
