"""
Cron job scheduling system for LAIA Agent.
...
Cron jobs are executed automatically by the gateway daemon:
    laia gateway install    # Install as a user service
    sudo laia gateway install --system  # Linux servers: boot-time system service
    laia gateway            # Or run in foreground
