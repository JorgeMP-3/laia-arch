...
class GatewayConfig:
    ...
    # Storage paths
    sessions_dir: Path = field(default_factory=lambda: get_laia_home() / "sessions")
...
def load_gateway_config() -> GatewayConfig:
    ...
    2. ~/.laia/config.yaml (primary user-facing config)
    3. ~/.laia/gateway.json (legacy — provides defaults under config.yaml)
    4. Built-in defaults
    """
    _home = get_laia_home()
    gw_data: dict = {}
