"""
Email platform adapter for the LAIA gateway.

Allows users to interact with LAIA by sending emails.
...
class EmailAdapter(BasePlatformAdapter):
    ...
    def _send_email(
        ...
        subject = ctx.get("subject", "LAIA Agent")
        ...
        msg_id = f"<laia-{uuid.uuid4().hex[:12]}@{self._address.split('@')[1]}>"
