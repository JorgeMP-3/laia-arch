...
TOOLSETS = {
    ...
    # ==========================================================================
    # Full LAIA toolsets (CLI + messaging platforms)
    #
    ...
    "laia-cli": {
        ...
        "tools": _LAIA_CORE_TOOLS,
        "includes": []
    },

    "laia-cron": {
        # Mirrors laia-cli so cron's "default" toolset is the same set of
        # core tools users see interactively — then `laia tools` filters
        # them down per the platform config. _DEFAULT_OFF_TOOLSETS (moa,
        # homeassistant, rl) are excluded by _get_platform_tools() unless
        # the user explicitly enables them.
        "description": "Default cron toolset - same core tools as laia-cli; gated by `laia tools`",
        "tools": _LAIA_CORE_TOOLS,
        "includes": []
    },
    ...
    "laia-email": {
        "description": "Email bot toolset - interact with LAIA via email (IMAP/SMTP)",
        "tools": _LAIA_CORE_TOOLS,
        "includes": []
    },
    ...
    "laia-sms": {
        "description": "SMS bot toolset - interact with LAIA via SMS (Twilio)",
        "tools": _LAIA_CORE_TOOLS,
        "includes": []
    },
    ...
    "laia-gateway": {
        ...
        "tools": [],
        "includes": ["laia-telegram", "laia-discord", "laia-whatsapp", "laia-slack", "laia-signal", "laia-bluebubbles", "laia-homeassistant", "laia-email", "laia-sms", "laia-mattermost", "laia-matrix", "laia-dingtalk", "laia-feishu", "laia-wecom", "laia-wecom-callback", "laia-weixin", "laia-qqbot", "laia-webhook", "laia-yuanbao"]
    }
}
