# Streaming LLM Response Support for LAIA Agent
...
```
LAIA_STREAMING_ENABLED=true    # Master switch via env
```
...
try:
    ...
    pass
# Env var override
if os.getenv("LAIA_STREAMING_ENABLED", "").lower() in ("true", "1", "yes"):
...
| `laia_cli/config.py` | 1 | +streaming config defaults |
