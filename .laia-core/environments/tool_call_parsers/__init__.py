...
def register_parser(name: str):
    ...
    Usage:
        @register_parser("laia")
        class LAIAToolCallParser(ToolCallParser):
            ...
    """
...
def get_parser(name: str) -> ToolCallParser:
    ...
    Args:
        name: Parser name (e.g., "laia", "mistral", "llama3_json")
...
from environments.tool_call_parsers.laia_parser import LAIAToolCallParser  # noqa: E402, F401
