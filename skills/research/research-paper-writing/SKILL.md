...
## LAIA Agent Integration

This skill is designed for the LAIA agent. It uses LAIA tools, delegation, scheduling, and memory for the full research lifecycle.

### Related Skills

Compose this skill with other LAIA skills for specific phases:
...
| **plan** | Phase 0 (Setup): creating structured plans before execution. Writes to `.laia/plans/` | `skill_view("plan")` |
