...
def curator_env(tmp_path, monkeypatch):
    """Isolated LAIA_HOME + freshly reloaded curator + skill_usage modules."""
    home = tmp_path / ".laia"
...
def test_cli_unpin_refuses_bundled_skill(curator_env, capsys):
    """laia curator unpin must refuse bundled/hub skills too (matches pin)."""
    from laia_cli import curator as cli
    skills_dir = curator_env["home"] / "skills"
