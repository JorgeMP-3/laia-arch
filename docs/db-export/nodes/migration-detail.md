# Migration System (Detailed)

## Metadata

- ID: `90`
- Slug: `migration-detail`
- Kind: `doc`
- Status: `active`
- Filename: `migration-detail.md`
- Parent: `context-engine-area`
- Source kind: `manual`
- Created at: `2026-05-08T08:34:00.490057+00:00`
- Updated at: `2026-05-19T11:33:14.566183+00:00`
- Aliases: `migration-detail`
...
```
This means for a workspace at `~/.laia/workspaces/my-workspace/`, the backup goes to `~/.laia/backups/legacy-workspaces/`.
...
```bash
cd ~/.laia/workspaces/mi-proyecto
tar -xzf ~/.laia/backups/legacy-workspaces/mi-proyecto-20260424T143052Z.tar.gz
```
