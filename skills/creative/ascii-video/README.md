...
Built for [LAIA Agent](https://github.com/NousResearch/laia-agent). Usable in any coding agent. Canonical source lives here; synced to [`NousResearch/laia-agent/skills/creative/ascii-video`](https://github.com/NousResearch/laia-agent/tree/main/skills/creative/ascii-video) via PR.
