"""
Skills configuration for LAIA Agent.
`laia skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.laia/config.yaml under:
...
from laia_cli.config import cfg_get, load_config, save_config
from laia_cli.colors import Colors, color
from laia_cli.platforms import PLATFORMS as _PLATFORMS
