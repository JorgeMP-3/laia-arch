...
class TestParserRegistry:
    ...
    def test_laia_parser_registered(self):
        parsers = list_parsers()
        assert "laia" in parsers
...
class TestLAIAParser:
    @pytest.fixture
    def parser(self):
        return get_parser("laia")
...
class TestParseResultContract:
    ...
    @pytest.fixture(params=["laia"])  # Add more as needed
    ...
    def test_tool_calls_are_proper_objects(self, parser):
        ...
        # Use laia format since that's universal
