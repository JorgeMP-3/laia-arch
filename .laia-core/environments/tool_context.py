...
ALL laia-agent tools, scoped to the rollout's task_id. The same task_id means
...
class ToolContext:
    """
    Open-ended access to all laia-agent tools for a specific rollout.
    ...
    def call_tool(self, tool_name: str, arguments: Dict[str, Any]) -> str:
        """
        Call any laia-agent tool by name.
    ...
    def cleanup(self):
        ...
        _prev_quiet = os.environ.get("LAIA_QUIET")
        ...
        try:
            ...
            if _prev_quiet is None:
                os.environ.pop("LAIA_QUIET", None)
            else:
                os.environ["LAIA_QUIET"] = _prev_quiet
