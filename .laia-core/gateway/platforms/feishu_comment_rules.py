...
Config: ~/.laia/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.laia/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_laia_home()`` helper (LAIA_HOME-aware and
...
RULES_FILE = get_laia_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_laia_home() / "feishu_comment_pairing.json"
