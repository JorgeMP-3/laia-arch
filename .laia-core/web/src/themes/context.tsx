...
const STORAGE_KEY = "laia-dashboard-theme";
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `laia_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "laia-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-laia-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-laia-theme-font", "true");
