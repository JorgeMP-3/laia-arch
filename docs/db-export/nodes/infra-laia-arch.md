# LAIA-ARCH Configuración

## Metadata

- ID: `114`
- Slug: `infra-laia-arch`
- Kind: `doc`
- Status: `active`
- Filename: `infra-laia-arch.md`
- Parent: `servidores-red`
- Source kind: `manual`
- Created at: `2026-05-08T08:35:13.585061+00:00`
- Updated at: `2026-05-19T11:34:16.245385+00:00`
- Aliases: `infra-laia-arch`
...
~/.laia/                ← runtime de Hermes (NO en git)
...
El script sincroniza skills, memorias y scripts desde `~/.laia/` a `~/laia-arch/hermes-config/` antes de commitear laia-infra.
