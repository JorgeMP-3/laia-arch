...
class TestFirecrawlClientConfig:
    ...
    def test_nous_auth_token_respects_laia_home_override(self, tmp_path):
        """Auth lookup should read from LAIA_HOME/auth.json, not ~/.laia/auth.json."""
        real_home = tmp_path / "real-home"
        (real_home / ".laia").mkdir(parents=True)
...
class TestBackendSelection:
    ...
    ``laia tools``.  Falls back to key-based detection for legacy/manual
    setups.
    """
