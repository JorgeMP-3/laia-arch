"""
LAIASweEnv -- SWE-Bench Style Environment with Modal Sandboxes
...
Usage:
    ...
    vllm serve YourModel --tool-parser laia
    run-api
    python environments/laia_swe_env.py serve \\
...
class LAIASweEnv(LAIAAgentBaseEnv):
    ...
    name = "laia-swe"
    env_config_cls = LAIASweEnvConfig

    @classmethod
    def config_init(cls) -> Tuple[LAIASweEnvConfig, List[APIServerConfig]]:
        """
        ...
        env_config = LAIASweEnvConfig(
            ...
            # Atropos settings
            group_size=4,
            tokenizer_name="NousResearch/DeepLAIA-3-Llama-3-3B-Preview",
            tool_call_parser="laia",
            steps_per_eval=50,
            total_steps=500,
            use_wandb=True,
            wandb_name="laia-swe",
        ...
        server_configs = [
            APIServerConfig(
                ...
                model_name="NousResearch/DeepLAIA-3-Llama-3-3B-Preview",
