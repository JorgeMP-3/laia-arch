...
Usage:
    laia pairing list              # Show all pending + approved users
    laia pairing approve <platform> <code>  # Approve a pairing code
    laia pairing revoke <platform> <user_id> # Revoke user access
    laia pairing clear-pending     # Clear all expired/pending codes
"""

def pairing_command(args):
    """Handle laia pairing subcommands."""
    ...
    if action == "list":
        ...
        print("Usage: laia pairing {list|approve|revoke|clear-pending}")
        print("Run 'laia pairing --help' for details.")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print("  Run 'laia pairing list' to see pending codes.\n")
