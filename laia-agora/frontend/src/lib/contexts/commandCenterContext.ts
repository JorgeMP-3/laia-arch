...
ROL: Hermes/LAIA — Orchestrator. Planifica, delega, revisa, documenta en workspace DB.
...
SYNAPSE DB-FIRST:
  ...
  - Hermes conserva la autoridad para editar/documentar nodos generales y fusionar conocimiento final.
...
// Dynamic profile: updates Hermes when the terminal list changes.
