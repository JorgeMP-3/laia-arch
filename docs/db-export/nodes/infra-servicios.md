...
- ID: `107`
- Slug: `infra-servicios`
- Kind: `doc`
- Status: `active`
- Filename: `infra-servicios.md`
- Parent: `servidores-red`
- Source kind: `manual`
- Created at: `2026-05-08T08:35:11.516199+00:00`
- Updated at: `2026-05-19T11:33:14.566183+00:00`
- Aliases: `infra-servicios`
...
```
Config en: `~/.laia/config.yaml`  
Auth en: `~/.laia/auth.json`
