...
```bash
python3 -m pyfiglet "LAIA" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=LAIA&font=Slant" | boxes -d stone
```
