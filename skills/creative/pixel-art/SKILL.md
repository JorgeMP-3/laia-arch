...
```python
import sys
sys.path.insert(0, "/home/teknium/.laia/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.laia/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — LAIA installs package this)
