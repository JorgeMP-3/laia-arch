# Plugin workspace-context (Detailed)

## Metadata

- ID: `88`
- Slug: `plugin-workspace-context-detail`
- Kind: `doc`
- Status: `active`
- Filename: `plugin-workspace-context-detail.md`
- Parent: `context-engine-area`
- Source kind: `manual`
- Created at: `2026-05-08T08:33:59.896093+00:00`
- Updated at: `2026-05-19T11:33:14.566183+00:00`
- Aliases: `plugin-workspace-context-detail`

## Summary

**workspace-context** is a DB-first nodal workspace memory provider for Hermes. It provides structur
...
- **Version:** 3.0.0
- **Plugin File:** `/Users/servidor_jmp/.laia/plugins/workspace-context/__init__.py`
- **Config File:** `/Users/servidor_jmp/.laia/plugins/workspace-context/plugin.yaml`
