...
def _inject_skill_config(loaded_skill: dict[str, Any], parts: list[str]) -> None:
    ...
    If the loaded skill's frontmatter declares ``metadata.laia.config``
    ...
    try:
        ...
        lines = ["", f"[Skill config (from {display_laia_home()}/config.yaml):"]
...
def scan_skill_commands() -> Dict[str, Dict[str, Any]]:
    """Scan ~/.laia/skills/ and return a mapping of /command -> skill info.
