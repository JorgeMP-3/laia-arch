#!/usr/bin/env python3
"""
SWE Runner with LAIA Trajectory Format

A runner that uses LAIA-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the LAIA-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses LAIA-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in LAIA format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches LAIA-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using LAIA-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with LAIA Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses LAIA-Agent's built-in execution environments
    and outputs trajectories in LAIA-Agent format.
    """
    ...
    def _convert_to_laia_format(
        ...
        """
        Convert internal message format to LAIA trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to LAIA trajectory format
        trajectory = self._convert_to_laia_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with LAIA trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with LAIA Trajectory Format")
    print("=" * 60)
