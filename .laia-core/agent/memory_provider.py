...
class MemoryProvider(ABC):
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        kwargs always include:
          - laia_home (str): The active LAIA_HOME directory path. Use this
            for profile-scoped storage instead of hardcoding ``~/.laia``.
        ...
        kwargs may also include:
          ...
          - agent_workspace (str): Shared workspace name (e.g. "laia").
    ...
    def get_config_schema(self) -> List[Dict[str, Any]]:
        ...
        Used by 'laia memory setup' to walk the user through configuration.
    ...
    def save_config(self, values: Dict[str, Any], laia_home: str) -> None:
        ...
        Called by 'laia memory setup' after collecting user inputs.
        ``values`` contains only non-secret fields (secrets go to .env).
        ``laia_home`` is the active LAIA_HOME directory path.
