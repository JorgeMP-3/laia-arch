...
The main() function in laia_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `laia -c model`
...
def _build_parser():
    """Build a minimal replica of the laia top-level parser."""
