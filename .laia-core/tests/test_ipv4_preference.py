...
def _reload_constants():
    """Reload laia_constants to get a fresh apply_ipv4_preference."""
    import laia_constants
    importlib.reload(laia_constants)
    return laia_constants
...
class TestApplyIPv4Preference:
    ...
    def test_patches_getaddrinfo_when_forced(self):
        ...
        assert getattr(socket.getaddrinfo, "_laia_ipv4_patched", False) is True
