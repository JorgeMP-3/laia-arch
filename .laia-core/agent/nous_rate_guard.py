...
(3 SDK retries x 3 LAIA retries), and every one of those calls counts
...
def _state_path() -> str:
    ...
    try:
        ...
        base = os.path.join(os.path.expanduser("~"), ".laia")
...
def is_genuine_nous_rate_limit(
    *,
    ...
    MiMo, LAIA, ...) behind one endpoint.  A 429 can mean either:
