...
def test_group_messages_can_require_direct_trigger_via_config():
    ...
    assert adapter._should_process_message(_group_message("hi @laia_bot", entities=[_mention_entity("hi @laia_bot")])) is True
    ...
    assert adapter._should_process_message(
        _group_message(
            "/status@laia_bot",
            entities=[_bot_command_entity("/status@laia_bot", "/status@laia_bot")],
        ),
        is_command=True,
    ) is True
