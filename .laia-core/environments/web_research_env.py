...
Inspired by: GroceryMind — production LAIA agent doing live web research
             across German grocery stores (firecrawl + laia-agent)
"""
...
# Ensure laia-agent root is on path
...
class WebResearchEnvConfig(LAIAAgentEnvConfig):
...
class WebResearchEnv(LAIAAgentBaseEnv):
    """
