...
class TestXiaomiNormalization:
    ...
    def test_vendor_prefix_mapping(self):
        from laia_cli.model_normalize import _VENDOR_PREFIXES
...
class TestXiaomiProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "xiaomi" in LAIA_OVERLAYS
        overlay = LAIA_OVERLAYS["xiaomi"]
...
class TestXiaomiDoctor:
    """Verify laia doctor recognizes Xiaomi env vars."""
